#module load horizon
    ...
    #     Channel 3: Throttle, R > Increase throttle,F > De crease throttle (Homework)
...
def override_channels(vehicle,channels):
        # Initialize all 18 channels with the 'IGNORE' value
...
channels={1:1500, 2:1500,3:1000,4:1500}
while True:
        #capture pressed key
